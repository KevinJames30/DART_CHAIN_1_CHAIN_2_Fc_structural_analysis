# Structural Analysis Pipeline for DART chain 1 and chain 2 with Fc DOMAINS

This repository contains structural bioinformatics pipeline developed in Google Colab to analyze, modify, and evaluate the structural characteristics of bispecific DART antibody targeting **endothelial surface transferrin receptor**. 
...
2. **Post-Translational Modification (PTM) Modeling:** Utilizes `Gemmi` to programmatically mutate and model specific chemical modifications (such as **methionine oxidation**) to assess structural stability and degradation risks.
